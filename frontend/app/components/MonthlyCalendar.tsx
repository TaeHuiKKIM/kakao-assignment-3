            ...
            {week.map((day, dIdx) => {
              ...
              return (
                <div 
                  ...
                  className={`flex flex-col items-center justify-center py-1 rounded-lg cursor-pointer transition-all duration-300 ${
                    isSelected 
                ...
                >
                  <span className={`text-xs ${isToday ? 'font-black text-primary' : 'font-semibold'} ${isSelected && isToday ? 'text-white' : ''} ${!isCurrentMonth && !isSelected ? 'text-gray-400' : isSelected ? 'text-white' : dayColor}`}>
                    {day.getDate()}
                  </span>
